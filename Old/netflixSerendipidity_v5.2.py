...
def loadMoviesOnNetflix():
    ...
    with open('DipyMoviesOnNetflix.csv', mode='r') as infile:
        ...
        text = StringVar()
        text.set('old')
        #titleTextString.set('Your expert recommended movie is: '+selectedMovieTitle)
        
        titleText = Label(root, textvariable = (titleTextString), font =( 
            'Verdana', 15), bg= 'black', fg = 'white')
          
        
        sourceText = Label(root, textvariable = ('This comes from: ' + selectedMovieSource), font =( 
                'Verdana', 15), bg= 'black', fg = 'white') 

        titleText.place(x = 100, y = 100)
        sourceText.place(x = 100, y = 120)
...
def updateMovieList():
    ...
    # Print progress text
    updatingText = Label(root, text = ('Launching Chrome...'), font =( 
            'Verdana', 15), bg= 'black', fg = 'white')
    ...
    """"""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
    # Print progress text
    updatingText = Label(root, text = ('Scanning for Sundance awarded films...'), font =( 
            'Verdana', 15), bg= 'black', fg = 'white')
    updatingText.place(x = 600, y = 100)
    ...
    # Print progress text
    updatingText = Label(root, text = ("Scanning for Palme d'Or winners..."), font =( 
            'Verdana', 15), bg= 'black', fg = 'white')
    updatingText.place(x = 600, y = 100)
    ...
    # Print progress text
    updatingText = Label(root, text = ("Scanning for Five Star Robert Ebert reviewed films..."), font =( 
            'Verdana', 15), bg= 'black', fg = 'white')
    updatingText.place(x = 600, y = 100)
    ...
    # Print progress text
    updatingText = Label(root, text = ("Saving scanned films..."), font =( 
            'Verdana', 15), bg= 'black', fg = 'white')
    updatingText.place(x = 600, y = 100)
    ...
    # Print progress text
    updatingText = Label(root, text = ("Saving films that are on Netflix..."), font =( 
            'Verdana', 15), bg= 'black', fg = 'white')
    updatingText.place(x = 600, y = 100)
...
usernameLabel.place(x = 190, y = 105)
usernameEntry.place(x = 280, y = 105)
...
passwordLabel.place(x = 190, y = 135)
passwordEntry.place(x = 280, y = 135)

# Login button
validateLogin = partial(validateLogin, username, password)
loginButton = tk.Button(root, text="Login", command=validateLogin) 
loginButton.place(x = 280, y =80)
...
updateListBtn = tk.Button(root, text ='Refresh movie list', command = updateMovieList,
                          bg= 'white')
updateListBtn.pack()
