...
print('Sean, your STARTING working directory is: ', os.getcwd())

driverPath = '/Users/Seansmac/Desktop/Dev/NetflixSerendipidity/chromedriver' # How does this work in prod?
os.chdir("/Users/Seansmac/Desktop/Dev/NetflixSerendipidity/dist") # How to do in prod?

print('Sean, your UPDATED working directory is: ', os.getcwd())
...
def loadMoviesOnNetflix():
     # Read from file      
    with open('/Users/Seansmac/Desktop/Dev/NetflixSerendipidity/DipyMoviesOnNetflix.csv', mode='r') as infile:
        reader = csv.reader(infile)
        readerII = csv.DictReader(open('/Users/Seansmac/Desktop/Dev/NetflixSerendipidity/DipyMoviesOnNetflix.csv'))
...
def updateMovieList(username, password):
    ...
    # Write to file
    with open('/Users/Seansmac/Desktop/Dev/NetflixSerendipidity/DipyScannedMovieList.csv', 'w') as f:  
        w = csv.writer(f)
  ...
  # Write to file
    with open('/Users/Seansmac/Desktop/Dev/NetflixSerendipidity/DipyMoviesOnNetflix.csv', 'w') as f:  
        w = csv.writer(f)
