...
def updateMovieList(username, password):
    try:
        ...
        try:
            ...
            updateText = Label(root, text = ("Error scanning for Sundance Film winners"), font =( 
                'Verdana', 15), bg= 'black', fg = 'white')
        ...
        try:
            ...
            updateText = Label(root, text = ("Error scanning for Cannes Film Festival winners"), font =( 
                'Verdana', 10), bg= 'black', fg = 'white')
            updateText.place(x = 90, y = 200)
        ...
        # Write to file
            ...
            try:
                ...
                pass
            os.system('say "Dipy movie scan complete. Press select a movie."')
            ...
            try:
                ...
                print('no text to destroy')
                pass
            updateText = Label(root, text = (e), font =('Verdana', 10), bg= 'black', fg = 'white')
            updateText.place(x = 90, y = 200)
            print("Exception 5")
...
openLinkButton.place(y = 150, x = 200)
